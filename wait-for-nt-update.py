# script to wait for NT case numbers for today to appear on covidlive.

import pandas as pd
import time

def covidlive_updated_today():
    """Check covidlive for NT case numbers for today, and return bool for whether
    they're there."""
    try:
        df = pd.read_html('https://covidlive.com.au/report/daily-source-overseas/nt')[1]
