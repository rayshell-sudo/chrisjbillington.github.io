...
def tweet_1_text():
    ...
    COMMENT_TEXT = f"""\
    TAS R_eff as of {today} with daily cases. Latest estimate:
    ...
    More info https://chrisbillington.net/COVID_TAS.html"""
...
if __name__ == '__main__':
    ...
    # Upload images
    linear = api.media_upload("COVID_TAS_linear.png")
    vax_linear = api.media_upload("COVID_TAS_vax_linear.png")
    log = api.media_upload("COVID_TAS.png")
    vax_log = api.media_upload("COVID_TAS_vax.png")
