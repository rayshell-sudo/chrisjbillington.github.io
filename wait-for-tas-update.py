# script to wait for TAS case numbers for today to appear on covidlive.

import pandas as pd
import time

def covidlive_updated_today():
    """Check covidlive for TAS case numbers for today, and return bool for whether
    they're there."""
    try:
        df = pd.read_html('https://covidlive.com.au/report/daily-source-overseas/tas')[1]
