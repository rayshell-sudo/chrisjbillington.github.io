...
def tweet_1_text():
    ...
    COMMENT_TEXT = f"""\
    NT R_eff as of {today} with daily cases and restrictions. Latest estimate:
    ...
    More info https://chrisbillington.net/COVID_NT.html"""
...
def tweet_3_text():
    ...
    COMMENT_TEXT = f"""\
    Cases in NT if the current trend continues:
...
if __name__ == '__main__':
    ...
    vax_linear = api.media_upload("COVID_NT_vax_linear.png")
    log = api.media_upload("COVID_NT.png")
    vax_log = api.media_upload("COVID_NT_vax.png")
