...
def tweet_1_text():
    ...
    COMMENT_TEXT = f"""\
    WA R_eff as of {today} with daily cases and restrictions. Latest estimate:
    ...
    More info https://chrisbillington.net/COVID_WA.html"""
...
def tweet_3_text():
    ...
    COMMENT_TEXT = f"""\
    Cases in WA if the current trend continues:
...
if __name__ == '__main__':
    ...
    # Upload images
    linear = api.media_upload("COVID_WA_linear.png")
    vax_linear = api.media_upload("COVID_WA_vax_linear.png")
    log = api.media_upload("COVID_WA.png")
    vax_log = api.media_upload("COVID_WA_vax.png")
