...
def covidlive_doses_per_100(n, state='NSW'):
    """return NSW cumulative 1st + 2nd doses per 100 population for the last n days"""
...
# methodology for remaking plots prior to then. Changed methodology back on 2021-12-11.
PRE_FIT_SMOOTHING = 5
