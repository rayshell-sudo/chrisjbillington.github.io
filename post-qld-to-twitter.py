...
def tweet_1_text():
    ...
    COMMENT_TEXT = f"""\
    QLD R_eff as of {today} with daily cases and restrictions. Latest estimate:
    ...
    More info https://chrisbillington.net/COVID_QLD.html"""
...
def tweet_3_text():
    ...
    COMMENT_TEXT = f"""\
    Cases in QLD if the current trend continues:
...
if __name__ == '__main__':
    ...
    # Upload images
    linear = api.media_upload("COVID_QLD_linear.png")
    vax_linear = api.media_upload("COVID_QLD_vax_linear.png")
    log = api.media_upload("COVID_QLD.png")
    vax_log = api.media_upload("COVID_QLD_vax.png")
